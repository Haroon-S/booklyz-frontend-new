      ...
      <Paper sx={{ ...commonPaperStyles, minHeight: 'calc(100vh - 160px)' }} className=" py-14 px-8">
        <Grid container>
          <Grid item xl={5} lg={5} md={6} sm={12}>
            <Stack spacing={4}>
              <Paper className="p-4">
                <Typography variant="h5">Text and journal entry templates</Typography>
                <Typography variant="body2" mb={2}>
                  Create text templates and copy into journals if necessary.
                </Typography>

                <Link
                  href="/portal/owner/journals/setting/manage-templates"
                  style={{ color: main }}
              ...
              <Paper className="p-4">
                <Typography variant="h5">Image templates</Typography>
                <Typography variant="body2" mb={2}>
                  Use generic image templates in the anatomical map.
                </Typography>

                <Link
                  href="/portal/owner/journals/setting/manage-images"
                  style={{ color: main }}
                  className="flex align-items-center"
                >
              ...
              <Paper className="p-4">
                ...
                <Typography variant="body2" mb={2}>
                  Place markers and comment on the image templates.
                </Typography>

                <Link
                  href="/portal/owner/journals/setting/manage-markers"
                  style={{ color: main }}
                  className="flex align-items-center"
                >
                  Manage markers <ChevronRight style={{ color: main }} />
                </Link>
              </Paper>
            </Stack>
          </Grid>
